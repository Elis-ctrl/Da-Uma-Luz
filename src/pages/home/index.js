  ...
  rootElement.innerHTML = `
    <main class='home-element'>
      ...
      <div class="text">
        ...
        <h3>Vantagens de ser uma empresa com selo Raízen:</h3>
        <ul>
