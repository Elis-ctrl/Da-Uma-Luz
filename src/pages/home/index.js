  ...
  <main class='home-element'>
    ...
    <div class='container-explication'></div>
      ...
      <p>
        ...
        <ul>
          <ui>Monitoramento remoto dos motoristas por meio de sistema de telemetria;</ui>
          <ui>Realização de inspeções anuais nas transportadoras contratadas com foco em Saúde, Segurança e Meio Ambiente (SSMA);</ui>
          <ui>Somente transportadoras com desempenho superior a 85% podem operar.</ui>
        </ul>
        ...
        <ul>
          <ui>Reconhecimento por ter uma energia totalmente renovável;</ui>
          <ui>Fechando negócio com a Raízen, você consome energia limpa e ainda recebe desconto nas taxas;</ui>
          <ui>Ser consumidor de uma empresa que zela por um produto de qualidade, que trás confiança e acompanhamento personalizado ao cliente.</ui>
        </ul>
      </p>
      <section class="body">
      <div class='logo'> 
